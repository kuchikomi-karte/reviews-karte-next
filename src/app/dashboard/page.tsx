...
const bizLabel: Record<string, string> = { hair: '美容室', nail: 'ネイルサロン', esthetic: 'エステサロン', other: 'その他' }
    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#f5f0e8', position: 'relative', overflow: 'hidden' }}>
      <header style={{ backgroundColor: '#0a0a0a', padding: '0 48px', height: '64px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '32px' }}>
          ...
          <span style={{ fontSize: '12px', color: '#cccccc', fontFamily: 'Noto Sans JP, sans-serif' }}>{displayName}</span>
      ...
      <main style={{ position: 'relative', zIndex: 1, padding: '48px', paddingRight: '480px' }}>
        <div style={{ maxWidth: '560px', marginBottom: '40px' }}>
          ...
          {hasSalonInfo ? (
            <div style={{ padding: '24px 28px', backgroundColor: 'white', border: '1px solid #ddd8ce' }}>
            ...
            <div style={{ padding: '24px 28px', backgroundColor: '#ede8df', border: '1px solid #ddd8ce' }}>
